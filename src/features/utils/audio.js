...
;
['touchstart', 'mousedown', 'keydown'].forEach(ev => document.addEventListener(ev, () => audioCtx?.resume(), { passive: true }));
...
export function toggleSound(btnEl) {
